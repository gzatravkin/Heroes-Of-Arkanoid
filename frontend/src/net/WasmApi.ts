...
export const wasmApi = {
  ...
  complete:         (level: string, treasureBonus = 0, riftMode = "none", blocks = 0, ballsDropped = 0) =>
                      Promise.resolve(call<any>("Complete", pid(), level, treasureBonus, riftMode, blocks, ballsDropped)),
