...
public class SaveWriter
{
	...
	/// </param>
	public static SaveWriter LoadFromStreamingAssets(string fileName)
	{
	...
	/// </exception>
	public static SaveWriter Load(string path)
	{	
		if(File.Exists(path) && Path.GetExtension(path) == extension)
		{
			...
			XmlSerializer serializer = new XmlSerializer(typeof(SaveWriter), additionalTypes.ToArray());
			TextReader textReader = new StreamReader(path);
			SaveWriter instance = (SaveWriter)serializer.Deserialize(textReader);
			textReader.Close();	
	...
	/// </summary>
	public void Save() { Save(Application.streamingAssetsPath+"\\"+fileName); }
